...
module.exports = async ({graphql, actions}) => {
  ...
  const guidesTemplate = resolve(__dirname, '../src/templates/guides.js');
  const topicsTemplate = resolve(__dirname, '../src/templates/topics.js');
  const tutorialTemplate = resolve(__dirname, '../src/templates/tutorial.js');
  const termsTemplate = resolve(__dirname, '../src/templates/terms.js');
  const specsTemplate = resolve(__dirname, '../src/templates/specs.js');
  ...
  allMarkdown.data.allMarkdownRemark.edges.forEach(edge => {
    ...
    if (slug === 'docs/error-decoder.html') {
      ...
      } else if (slug.includes('topics/')) {
        template = topicsTemplate;
      }  else if (slug.includes('specs/')) {
        template = specsTemplate;
      } else if (slug.includes('tutorial/')) {
        template = tutorialTemplate;
      } else if (slug.includes('terms/')) {
